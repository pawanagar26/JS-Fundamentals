...
const movementsIND = movements.map(mov => mov * eurToUsd);
...
/*
// The find method
const firstWithdrawal = movements.find(mov => mov < 10);
console.log(movements);
...
//   movement > 0 ? 'depisits' : 'withdrawals'
// );
// console.log(groupedMovements);

const gropedByActivity = object.groupBy(accounts, account => {
